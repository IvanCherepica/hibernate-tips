...
public class DeleteCascadeProblem_2 {
    ...
    public static class Post {
        ...
        public void preRemove() {
            System.out.println("Pre-Removing operation Post");
        }

        @PostRemove
        public void postRemove() {
            System.out.println("Post-Remove operation Post");
        }
    ...
    public static class PostComment {
        ...
        @PreRemove
        public void preRemove() {
            System.out.println("Pre-Removing operation PostComment");
        }

        @PostRemove
        public void postRemove() {
            System.out.println("Post-Remove operation PostComment");
        }
