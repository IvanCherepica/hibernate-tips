...
public class HibernateSpecificMapping {
    public static void main(String[] args) {
        ...
        {//проблема в следующем: данный пример рассматривает связь, организованную черз третью смежную таблицу и коллекцию
            // на стороне собственника связи. из-за такой сложной структуры не получается составить запрос, который бы говорил хибернейту,
            //каким образом надо мапить присоединенные объекты. это ещё одна причина никогда не строить связь подобным образом
            entityManager.getTransaction().begin();
