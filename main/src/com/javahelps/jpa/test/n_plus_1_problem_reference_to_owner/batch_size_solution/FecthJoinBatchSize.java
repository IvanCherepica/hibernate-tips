package com.javahelps.jpa.test.n_plus_1_problem_reference_to_owner.batch_size_solution;
...
public class FecthJoinBatchSize {
    public static void main(String[] args) {
        ...
        {//абсолютно такая же картина, что и с EAGER
