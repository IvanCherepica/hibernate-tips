...
public class PersistenceUnitInfoImpl implements PersistenceUnitInfo {
    ...
    public PersistenceUnitInfoImpl(List<String> managedClassNames) {
        this.managedClassNames = managedClassNames;
    }

    public PersistenceUnitInfoImpl(Class[] managedClassNames) {
        this.managedClassNames = Arrays.stream(managedClassNames)
                .map(Class::getName)
