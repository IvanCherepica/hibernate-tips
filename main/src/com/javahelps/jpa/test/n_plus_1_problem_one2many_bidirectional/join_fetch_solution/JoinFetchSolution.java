package com.javahelps.jpa.test.n_plus_1_problem_one2many_bidirectional.join_fetch_solution;
...
public class JoinFetchSolution {
    public static void main(String[] args) {
        ...
        {//убираем n+1 при выборке листа StockDailyRecord
            ...
            List<StockDailyRecord> results = entityManager.createQuery(
                    "FROM "+StockDailyRecord.class.getName()+" sdr JOIN FETCH sdr.stock",
        ...
        {//убираем n+1 при выборке листа Stock
            ...
            List<Stock> results = entityManager.createQuery(
                    "FROM "+Stock.class.getName()+" s JOIN FETCH s.stockDailyRecords",
                    Stock.class
            )
                    .getResultList();
