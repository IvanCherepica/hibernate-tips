...
public class _40_Solution {
    public static void main(String[] args) {
        ...
        List<Task> tasks = entityManager.createNativeQuery("select solutio.id, answers.id, solutio.title, answers.answer, answers.answer_id, answers.answer_id, answers.id from task solutio inner join answer answers on solutio.id=answers.answer_id", Task.class).getResultList();
