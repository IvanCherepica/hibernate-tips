...
//        }
        ...
        {//воспольззовавшись етодм getReference - избавляемся от необходимости полность вычищать контекст перситстентноти
            entityManager.getTransaction().begin();
    ...
    private static void saveData(EntityManager entityManager) {
        ...
        Address address3 = new Address("street 3");
