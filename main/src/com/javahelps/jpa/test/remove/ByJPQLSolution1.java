...
public class ByJPQLSolution1 {
    ...
    public static void main(String[] args) {
        ...
        {//одним из возможных вариантов будет вызов метода detach, но в таком случае, нам все равно потребуется сущность для вызова этого метода
            entityManager.getTransaction().begin();
