...
public class ByJPQLProblem {
    ...
    public static void main(String[] args) {
        ...
        {//удаляем только что загруженную сущность спомощью hql запроса
            entityManager.getTransaction().begin();
        ...
        {//после выполнения запроса контекст не синхронизируется и мы получаем из контекста уже удаленную сущность. будто она все ещё существует
            entityManager.getTransaction().begin();
            System.out.println();
